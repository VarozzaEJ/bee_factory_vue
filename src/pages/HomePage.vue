        ...
        <div class="col-6  flex-column bee-yellow">
          <div class="row">
            <div class="col-3 d-flex flex-column justify-content-start">
              ...
              <button :disabled="AppState.pollen <= 50" @click="buyClickUpgrade('Bee')"
                class="btn btn-warning my-3"><span id="beePrice">50</span> <i
          ...
          <div class="row">
            <div class="col-6 d-flex flex-column justify-content-between">
              ...
              <div class="d-flex justify-content-between align-items-center mb-3">
                <span class="fs-4 border border-light rounded px-2" id="bee-quantity">{{ clickUpgrades[0].quantity
                  }}</span>
                <span class="fs-5 ps-4">Bees</span>
                <span class="fs-4"> <i class="mdi mdi-arrow-right"></i></span>
                <span class="fs-4 ms-4 border border-light rounded px-2" id="click-power">{{ clickPower }}</span>
              </div>

              <div class="d-flex justify-content-between align-items-center mb-3">
                <span class="fs-4 border border-light rounded px-2" id="hive-quantity">{{ clickUpgrades[1].quantity
                  }}</span>
                <span class="fs-5 ps-4">Hives</span>
                <span class="fs-4"> <i class="mdi mdi-arrow-right"></i></span>
                <span class="fs-4 ms-4 border border-light rounded px-2" id="hive-power">{{ clickPower }}</span>
              </div>
            ...
            <div class="col-6 d-flex flex-column justify-content-between">
              ...
              <div class="d-flex justify-content-between align-items-center mb-3">
                <span class="fs-4 border border-light rounded px-2" id="superbee-quantity">{{ autoUpgrades[0].quantity
                  }}</span>
                <span class="fs-5 ps-4">SuperBees</span>
                <span class="fs-4"> <i class="mdi mdi-timer"></i></span>
                <span class="fs-4 ms-4 border border-light rounded px-2" id="superbee-power">{{ autoUpgrades[0].quantity
                  * autoUpgrades[0].multiplier }}</span>
              </div>

              <div class="d-flex justify-content-between align-items-center mb-3">
                <span class="fs-4 border border-light rounded px-2" id="queenbee-quantity">{{ autoUpgrades[1].quantity
                  }}</span>
                <span class="fs-5 ps-4">QueenBees</span>
                <span class="fs-4"> <i class="mdi mdi-timer"></i></span>
                <span class="fs-4 ms-4 border border-light rounded px-2" id="queenbee-power">{{ autoUpgrades[1].quantity
                  * autoUpgrades[1].multiplier }}</span>
              </div>
